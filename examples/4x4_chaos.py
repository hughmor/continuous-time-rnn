...
W = [
    [0.00324943, -0.53023755, 0.7102021, 0.46308806,],
    [-0.30315056, 0.73053573, 0.60528764, -0.08968923,],
    [0.03423932, 0.36917016, -0.29807632, 0.87959739,],
    [0.95232182, 0.22108614, 0.20097352, -0.06175531,],
    ]
...
x0 = np.array([0, 0.75, 0.25, 1])
width = np.array([15, 15, 15, 15])*np.pi * 1e-2
gain = 0.25 * np.ones_like(x0)
